...
const Hero = () => {
  ...
  return (
    ...
    >
      <h1 className="font-display col-span-12 mt-26 h-fit overflow-hidden text-6xl text-black lg:col-start-1 lg:col-end-7 lg:mt-0 lg:text-[9.6875rem] lg:leading-[calc(9.6875rem*1.2)] 2xl:text-[13.5rem] 2xl:leading-[calc(13.5rem*1.2)]">
        <span className="heading inline-block translate-y-full">rebel</span>
      </h1>
      <h1 className="font-display col-span-12 h-fit overflow-hidden text-6xl text-black lg:col-start-3 lg:col-end-12 lg:text-[9.6875rem] lg:leading-[calc(9.6875rem*1.2)] 2xl:text-[13.5rem] 2xl:leading-[calc(13.5rem*1.2)]">
        <span className="heading inline-block translate-y-full">against</span>
      </h1>
      <h1 className="font-display col-span-12 h-fit overflow-hidden text-6xl text-black lg:col-start-1 lg:col-end-9 lg:text-[9.6875rem] lg:leading-[calc(9.6875rem*1.2)] 2xl:text-[13.5rem] 2xl:leading-[calc(13.5rem*1.2)]">
        <span className="heading inline-block translate-y-full">boring</span>
      </h1>
